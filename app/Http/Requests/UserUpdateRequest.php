...
class UserUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'current_password'  => 'required_with:new_password|string|min:5',
            'new_password'      => 'required_with:current_password|string|min:5|confirmed',
            'nickname'          => 'sometimes|string|min:6|max:20|unique:users,nickname,' . $this->user()->id,
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'nickname.max'                   => 'O seu nickname passa o máximo de caracteres',
            'nickname.min'                   => 'O seu nickname não tem minímo de caracteres',
            'nickname.string'                => 'O campo nickname deve ser uma string.',
            'nickname.unique'                => 'Esse nickname já está em uso.',
        ];
    }
}